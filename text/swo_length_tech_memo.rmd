...
On the Alaska Fishery Science Center bottom trawl surveys length frequency data are collected and sex is subsequently determined from a subset of these collected data so that sex-specific length composition data are available for assessment of groundfish stocks. Determining sex from the length frequency data has resulted in acute and repetitive stress injuries of survey staff, and these injuries have become increasingly common. In December 2021 a working group was formed (the Survey Workflow Optimization working group) to evaluate the effect on length composition uncertainty of reducing the amount of length frequency data for which sex is determined from historical levels in the bottom trawl surveys. Over the spring of 2022 the working group developed a bootstrap-simulation approach that determined the amount of uncertainty gained by reducing the amount of length frequency data for which sex was subsequently determined. It was shown that the length composition input sample size was reduced by 25% or less compared to the input sample size for the full historical data sets for subsampling levels of 100 fish per haul for which sex was subsequently determined. Upon meeting with stock assessment authors the joint recommendation between the working group and assessment authors to the survey staff was to limit length frequency data for which sex is subsequently determined to 100 subsampled fish per haul.
