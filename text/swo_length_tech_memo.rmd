...
The subsample levels that we evaluated for subsequent sex determination from the length frequency collections were 50, 75, 100, 125, 150, and 175 samples. 
...
These trends were similar within years as well (Table \@ref(tab:tbl2)). 
The species most frequently sampled for lengths across all the surveys was walleye pollock in the eastern Bering Sea survey, with nearly 50% more samples in some years as the next most frequently sampled species (arrowtooth flounder in the Gulf of Alaska).
