...
```{r bs-samples-per-haul, fig.cap="Number of sexed length samples collected per haul compared to catch per haul for the most recent three years of the eastern Bering Sea bottom trawl survey. The red dashed line represents the historical target sample size of 200."}
