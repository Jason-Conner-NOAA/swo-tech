...
It was shown that the length composition input sample size was reduced by 25% or less compared to the input sample size for the full historical data sets for sub-sampling levels of 100 fish per haul for which sex was subsequently determined. 
...
Although, while the input sample size for sex-specific length composition resulted in a larger decrease compared to other species, the eastern Bering Sea walleye pollock stock assessment is not a sex-specific assessment but a single-sex assessment and uses the total length composition [@Ianelli2021], thus, the input sample size for the assessment model would remained unchanged regardless of the sub-sampling level for sex determination of the length frequency collections. 
...
knitr::include_graphics(here::here('figs', 'ebs_samples_per_haul.png'))
```
