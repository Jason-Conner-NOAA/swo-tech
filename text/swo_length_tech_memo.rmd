...
In December 2021 a working group was formed (the Survey Workflow Optimization working group) to evaluate the effect on length composition uncertainty of reducing the amount of length frequency data for which sex is determined from historical levels in the bottom trawl surveys. 
...
## Computing effective sand input ample size
