...
The order of operations has the following schedule, with steps 1-3 being optional switches:
...
[Para on reduction in historical sampling based on sub-sample sizes]

[Para on ESS compared to base - both using boxplots and harmonic mean]

[Para on proportion of base ESS]
