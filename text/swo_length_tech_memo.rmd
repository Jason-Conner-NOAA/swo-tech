...
**[Historical sample size para - including table of avg of total sample size over the most recent 3 years and average sample size per haul by sex category, could include Meaghan’s figures from presentation too]**
## Historical length sampling 
The database (i.e. RACEBASE) was queried using the sumfish package in Program R (*Add Conner reference*). Raw length sample data were summarized to determine the average number of sex-specific and unsexed length samples over the past three years by survey and species. Additionally we summarized the number of sex-specific lengths and total number of lengths collected per haul over time.  
...
This is often referred to as the ‘first stage expansion’ and is a common method to obtain population estimates at length from area-swept survey data (ref). 
...
The average total number lengths sampled over the past three surveys is summarized for each survey and species of interest in ... The species with the greatest average total number of lengths sampled varied by survey. The top five species for the eastern Bering Sea shelf bottom trawl survey are walleye pollock, yellowfin sole, northern rock sole, flathead sole, and arrowtooth flounder; POP, northern rock sole, northern rockfish, walleye pollock, and arrowtooth flounder for the Aleutian Islands bottom trawl survey; and arrowtooth flounder, POP, walleye pollock, flathead sole, and rex sole for the Gulf of Alaska bottom trawl survey.
